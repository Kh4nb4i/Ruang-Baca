    ...
    <div class="box box-primary">
        <div class="box-header with-border" style="border-bottom: 1px solid #f1f5f9; padding-bottom: 15px; margin-bottom: 15px;">
            <div style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 10px; width: 100%;">
                <a href="?page=MyApp/add_magang" title="Tambah Laporan Magang" class="btn btn-primary" style="border-radius: 8px !important; font-weight: 600;">
        ...
        <div id="exportPanel" style="display: none; background: #f8fafc; border: 1px solid #e2e8f0; border-radius: 8px; padding: 15px; margin: 0 15px 15px 15px;">
            <h4 style="margin-top: 0; font-size: 14px; font-weight: bold; color: #0f172a; margin-bottom: 15px;"><i class="fa fa-filter" style="color: #3b82f6;"></i> Filter & Ekspor Laporan Magang</h4>
            <form action="index.php" method="get" target="_blank">
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <div class="form-group" style="margin-bottom: 10px !important;">
                            <label style="font-size: 12px; color: #475569;">Tempat Magang</label>
                            <input type="text" name="tempat" class="form-control input-sm" placeholder="Contoh: PT..." style="border-radius: 6px;">
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group" style="margin-bottom: 10px !important;">
            ...
            <div class="table-responsive">
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        <?php
                        $no = 1;
                        $sql = $koneksi->query("SELECT * FROM tb_magang ORDER BY id_magang DESC");
                        ...
                        ?>
                            <tr>
                                ...
                                <td><?php echo htmlspecialchars($data['tempat_magang']); ?></td>
                                <td>
                                    <?php if (!empty($data['file_laporan']) && file_exists('uploads/magang/' . $data['file_laporan'])): ?>
                                        <a href="uploads/magang/<?php echo htmlspecialchars($data['file_laporan']); ?>" download class="btn btn-info btn-xs" style="border-radius: 6px !important; padding: 5px 10px !important; font-weight: 600;">
                                ...
                                <td>
                                    <a href="?page=MyApp/edit_magang&kode=<?php echo $data['id_magang']; ?>" title="Ubah" class="btn btn-success btn-xs" style="border-radius: 6px !important; padding: 5px 10px !important;">
                                        <i class="fa fa-edit"></i>
                                    </a>
                                    <a href="?page=MyApp/del_magang&kode=<?php echo $data['id_magang']; ?>" onclick="confirmAction(event, this.href, 'Hapus Laporan Magang', 'Apakah Anda yakin ingin menghapus laporan magang ini?', 'warning', '#ef4444', 'Ya, Hapus')" title="Hapus" class="btn btn-danger btn-xs" style="border-radius: 6px !important; padding: 5px 10px !important;">
